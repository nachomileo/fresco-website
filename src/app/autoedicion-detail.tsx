      ...
      <article className="workshop-page seminar-page">
        <header className="workshop-hero">
          ...
          <div className="workshop-hero-copy">
            ...
            <div className="workshop-hero-action" id="inscripcion">
              <dl><div><dt>Fecha</dt><dd>Febrero—mayo 2027</dd></div><div><dt>Lugar</dt><dd>Carabanchel, Madrid</dd></div><div><dt>Duración</dt><dd>23 horas + open studio</dd></div><div><dt>Precio</dt><dd>450 €</dd></div></dl>
        ...
        <section className="workshop-info">
          ...
          <dl>
            ...
            <div><dt>Precio</dt><dd>450 €</dd></div>
            <div><dt>Pago</dt><dd>Reserva de 150 € y dos pagos de 150 €</dd></div>
